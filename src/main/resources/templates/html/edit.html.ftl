@layout("/common/_container.html",{bg:"bg-white",js:["/assets/modular/shenjiang/${table.entityPath}/${table.entityPath}_edit.js?v=1"]}){
<style type="text/css">
    .layui-upload-list{
        margin-left: 110px;
    }
...
<form id="${table.entityPath}Form" lay-filter="${table.entityPath}Form" class="layui-form model-form" style="max-width: 700px;">
    ...
    <div class="layui-form-item text-right">
        <button class="layui-btn" lay-filter="btnSubmit" lay-submit>更新</button>
